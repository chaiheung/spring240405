...
public class Controller14 {
    ...
    public void sub1(Model model) {
        MyBean14A o1 = new MyBean14A("신촌", "한국", 33, "흥민");
        MyBean14B o2 = new MyBean14B();
        o2.setName("강인");
        o2.setId("19");
        o2.setAge(22);
    ...
    @RequestMapping("sub3")
    public void sub3(@ModelAttribute("player1") MyBean14B o1) {
        o1.setName("오타니");
    }

    @RequestMapping("sub4")
    public String sub4(@ModelAttribute MyBean14B o1) {
        o1.setName("김민재");
    ...
    @RequestMapping("sub5")
    public String sub5(MyBean14B o1) {
    ...
    @RequestMapping("sub7")
    public String sub7(MyBean14C o1) {
        o1.setAddress("신촌");
    ...
    public String sub10(MyBean14E o1) {
        return "/main14/sub9";
    }
    ...
    public void sub11(MyBean14F o1) {
    }
    ...
    public void sub12(
            ...
            MyBean14G o1, // @ModelAttribute
            MyBean14F o2 // @ModelAttribute
    ) {
